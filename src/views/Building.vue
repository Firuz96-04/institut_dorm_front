...
<template>
    <div class="card my_table">
        <DataTable :value="buildings" class="p-datatable-sm" showGridlines scrollable scrollHeight="400px">
            <Column field="name" headerClass="column-text-center" header="Названия" style="width: 25%" class="font-bold my_column"></Column>
            <Column field="floor_count" header="Этажность" class="column-text-center text-center" style="width: 15%">
                <template #body="{ data }">
